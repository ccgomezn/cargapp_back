...
class UserLocationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_location" do
    assert_difference('UserLocation.count') do
      post user_locations_url, params: { user_location: { active: @user_location.active, city_id: @user_location.city_id, latitude: @user_location.latitude, longitude: @user_location.longitude, user_id: @user_location.user_id } }
    end
  ...
  test "should update user_location" do
    patch user_location_url(@user_location), params: { user_location: { active: @user_location.active, city_id: @user_location.city_id, latitude: @user_location.latitude, longitude: @user_location.longitude, user_id: @user_location.user_id } }
