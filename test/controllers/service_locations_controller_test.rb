...
class ServiceLocationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create service_location" do
    assert_difference('ServiceLocation.count') do
      post service_locations_url, params: { service_location: { active: @service_location.active, city_id: @service_location.city_id, latitude: @service_location.latitude, longitude: @service_location.longitude, service_id: @service_location.service_id, user_id: @service_location.user_id } }
    end
  ...
  test "should update service_location" do
    patch service_location_url(@service_location), params: { service_location: { active: @service_location.active, city_id: @service_location.city_id, latitude: @service_location.latitude, longitude: @service_location.longitude, service_id: @service_location.service_id, user_id: @service_location.user_id } }
