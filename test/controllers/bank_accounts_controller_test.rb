...
class BankAccountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank_account" do
    assert_difference('BankAccount.count') do
      post bank_accounts_url, params: { bank_account: { account_number: @bank_account.account_number, account_type: @bank_account.account_type, active: @bank_account.active, bank: @bank_account.bank, statu_id: @bank_account.statu_id, user_id: @bank_account.user_id } }
    end
  ...
  test "should update bank_account" do
    patch bank_account_url(@bank_account), params: { bank_account: { account_number: @bank_account.account_number, account_type: @bank_account.account_type, active: @bank_account.active, bank: @bank_account.bank, statu_id: @bank_account.statu_id, user_id: @bank_account.user_id } }
