Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "CarGapp_production"
  ...
  config.action_mailer.smtp_settings = {
    ...
    port:                 ENV['MAILER_POWER_PORT'],
    domain:               ENV['MAILER_POWER_DOMAIN'],
    user_name:            ENV['MAILER_POWER_USER_NAME'],
    password:             ENV['MAILER_POWER_PASSWORD'],
